                ...
                <form action="update_product.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-4 col-12">
                        ...
                        <div class="input-group align-items-baseline">
                            ...
                            <button class="btn add-cat" type="button">
                                <a href="./add_category.php" class="text-decoration-none text-primary">Add New Category >></a>
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="mb-5 mt-3">
                        ...
                        <img src="<?= htmlspecialchars($product['image']); ?>" width="100" height="100" class="rounded"><br>
